...
const DataPlugin = require('./core/data-plugin')
...
function nuxtModule(moduleOptions) {
  ...
  const optionsForPlugin = { ...options }
  console.log('options: ', options)
  console.log('optionsForPlugin: ', optionsForPlugin)
  ...
  const cmsDataPlugin = new DataPlugin(CONFIG)
  // console.log('cmsDataPlugin: ', cmsDataPlugin)

  // console.log(cmsDataPlugin.getDataFiles())
  ...
  DataWatcher
    .on('ready', () => {
      ...
      // console.log('DataTransformer - dataFiles', cmsDataPlugin.data)
      // console.log('DataTransformer - getDataFiles', cmsDataPlugin.getDataFiles())
      // handleData(CONFIG)
      cmsDataPlugin
        .handleData()
        .handleRoutes()
    ...
    .on('delete', (filepath, root) => {
      ...
      cmsDataPlugin.deleteApiFile(filepath).handleRoutes()
      // console.log('DataTransformer - dataFiles', cmsDataPlugin.data)
      // console.log('DataTransformer - getDataFiles', cmsDataPlugin.getDataFiles())
      // handleData(CONFIG)
    })
...
//     console.log('HANDLE DATA - fileSlug: ', fileSlug)

//     try {
//       // console.log('FILE: ', file)
//       const fileData = yaml.safeLoad(CONFIG.Data.read(file)) || {}
//       CONFIG.Api.write(`${fileSlug}/index.json`, fileData)
//     } catch (e) {
//       console.log(e)
//     }
//   })
