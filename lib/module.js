...
function initialWrite(CONFIG) {
  ...
  // handleCollectionDirectories(CONFIG)
...
const getCollectionDirectories = (CONFIG) => {
  return CONFIG.Content.find({ matching: ['*', '!_*'], files: false, directories: true })
}
...
const saveCollectionDirectoriesFile = (CONFIG, collectionDirectoriesArray) => {
  return CONFIG.Api.write(`collections/index.json`, collectionDirectoriesArray)
}

const handleCollectionDirectories = (CONFIG) => {
  const collectionDirectories = getCollectionDirectories(CONFIG)
  console.log('FROM handleCollectionDirectories - collectionDirectories: ', collectionDirectories)

  saveCollectionDirectoriesFile(CONFIG, collectionDirectories)
}
...
const handleApiRoutes = (CONFIG) => {
  ...
  console.log('FROM handleApiRoutes - apiRoutes: ', apiRoutes)
...
const handleData = (CONFIG, filepath) => {
  console.log('handleData running...')
