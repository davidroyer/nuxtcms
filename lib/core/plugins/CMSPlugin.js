...
class ContentPlugin extends BaseGenerator {
  ...
  get contentTypes() {
    ...
    console.log('🚀 ~ file: CmsPlugin.js ~ line 41 ~ ContentPlugin ~ getcontentTypes ~ contentTypes', contentTypes)
    return contentTypes
  ...
  generateRoutesFile() {
    ...
    // eslint-disable-next-line no-console
    console.log('🚀 ~ file: CmsPlugin.js ~ line 181 ~ ContentPlugin ~ generateRoutesFile ~ contentRoutes', contentRoutes)
