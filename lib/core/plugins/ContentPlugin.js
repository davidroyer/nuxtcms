...
class ContentPlugin extends BaseGenerator {
  ...
  generateTagsFile(contentType) {
    ...
    console.log('TCL: ContentPlugin -> generateTagsFile -> tagsApiData', tagsApiData)
    const tagsArray = Object.keys(tagsApiData)
    console.log(tagsArray.length === 0)
  ...
  updateData(contentType, filepath) {
    console.log('TCL: ContentPlugin -> updateData -> contentType, filepath', contentType, filepath)
