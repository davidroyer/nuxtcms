...
const DataTransformer = require('./core/data')
...
function nuxtModule(moduleOptions) {
  ...
  const cmsData = new DataTransformer(CONFIG)
  // console.log('cmsData: ', cmsData)

  // console.log(cmsData.getDataFiles())
  ...
  DataWatcher
    .on('ready', () => {
      ...
      console.log('DataTransformer - dataFiles', cmsData.data)
      console.log('DataTransformer - getDataFiles', cmsData.getDataFiles())
      handleData(CONFIG)
    })
    .on('change', (filepath, root, stat) => {
      console.log('DataWatcher - CHANGE: ', filepath)
      console.log('DataTransformer - data', cmsData.data)
      console.log('DataTransformer - getDataFiles', cmsData.getDataFiles())
      handleData(CONFIG)
    })
    .on('delete', (filepath, root) => {
      console.log('DataWatcher - DELETE: ', filepath)
      cmsData.deleteApiFile(filepath)
      console.log('DataTransformer - dataFiles', cmsData.data)
      console.log('DataTransformer - getDataFiles', cmsData.getDataFiles())
      handleData(CONFIG)
    })
