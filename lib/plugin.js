...
import dataApiFile from '@/_CMS/api/data'
/**
...
export default (context, inject) => {
  ...
  /**
   * Creates content on context for each data file my using the camelCase version of the filename
   */
   ...
   */
  context.$dataApi = dataApiFile
  inject('dataApi', dataApiFile)
