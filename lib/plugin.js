...
import contentRoutes from '@/_api/routes/content'
...
export default (context, inject) => {
  ...
  if (context.isDev) {
    // contentRoutes.forEach(contentType => {
    //   const contentKey = createKeys(contentType)
    //   const data = require(`@/static/api/${contentType}`)
